...
# How to use :  blockMesh_nonRotating_generator_3D.py fileWithXYZprofile.txt
# ---------------------------------------------------------------------------
...
cd = 300 #number of cells downstream in the static mesh (between points 49 and 38)
cv = 250 #number of cells in the vertical direction in the static part
...
outputFile = 'profileLayers_nonRotating.png'
...
vd=Q_N(points[8,2]-points[78,2],dl0,2*3.14159*scyl/(4*cle))
...
ds=Q_N(points[66,0]-points[3,0],np.sqrt((points[92,0]-points[1,0])**2+(points[1,2]-points[92,2])**2)/cte,dl0)
...
bmd.write('('+'\n')
bmd.write(''+'\n')
bmd.write('    hex (43 40 48 51 47 44 52 55) shape ('+str(cle)+' '+str(N43_51)+' 10) edgeGrading (1 1 1 1 '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' 1 1 1 1)'+'\n')
bmd.write('    hex (40 56 22 48 44 58 26 52) shape ('+str(cle/2)+' '+str(N43_51)+' 10) edgeGrading (1 1 1 1 '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' 1 1 1 1)'+'\n')
...
#2
bmd.write('    hex (56 100 101 22 58 103 104 26) shape ('+str(cle/2)+' '+str(N43_51)+' 10) edgeGrading (1 1 1 1 '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' 1 1 1 1)'+'\n')
bmd.write('    hex (100 41 49 101 103 45 53 104) shape ('+str(cle/4)+' '+str(N43_51)+' 10) edgeGrading (1 1 1 1 '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' 1 1 1 1)'+'\n')

bmd.write('    hex (41 57 23 49 45 59 27 53) shape ('+str(cle/2)+' '+str(N43_51)+' 10) edgeGrading (1 1 1 1 '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' 1 1 1 1)'+'\n')
bmd.write('    hex (57 42 50 23 59 46 54 27) shape ('+str(cle/2)+' '+str(N43_51)+' 10) edgeGrading (1 1 1 1 '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' 1 1 1 1)'+'\n')
bmd.write('    hex (42 43 51 50 46 47 55 54) shape ('+str(cle)+' '+str(N43_51)+' 10) edgeGrading (1 1 1 1 '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' '+str(Q43_51)+' 1 1 1 1)'+'\n')
bmd.write('    hex (51 48 17 16 55 52 20 19) shape ('+str(cle)+' '+str(cv)+' 10) edgeGrading (1 '+str(1/Q17_16)+' '+str(1/Q17_16)+' 1 '+str(Q48_17)+' '+str(Q48_17)+' '+str(Q48_17)+' '+str(Q48_17)+' 1 1 1 1)'+'\n')
bmd.write('    hex (50 51 16 18 54 55 19 21) shape ('+str(cle)+' '+str(cv)+' 10) edgeGrading (1 '+str(Q17_16)+' '+str(Q17_16)+' 1 '+str(Q48_17)+' '+str(Q48_17)+' '+str(Q48_17)+' '+str(Q48_17)+' 1 1 1 1)'+'\n')
bmd.write('    hex (48 22 24 17 52 26 28 20) shape ('+str(cle/2)+' '+str(cv)+' 10) edgeGrading (1 1 1 1 '+str(Q48_17)+' '+str(Q22_24)+' '+str(Q22_24)+' '+str(Q48_17)+' 1 1 1 1)'+'\n')
bmd.write('    hex (23 50 18 25 27 54 21 29) shape ('+str(cle/2)+' '+str(cv)+' 10) edgeGrading (1 1 1 1 '+str(Q22_24)+' '+str(Q48_17)+' '+str(Q48_17)+' '+str(Q22_24)+' 1 1 1 1)'+'\n')
bmd.write('    hex (22 30 34 24 26 32 36 28) shape ('+str(cd)+' '+str(cv)+' 10) edgeGrading ('+str(Q22_30)+' '+str(Q22_30)+' '+str(Q22_30)+' '+str(Q22_30)+' '+str(Q22_24)+' '+str(Q22_24)+' '+str(Q22_24)+' '+str(Q22_24)+' 1 1 1 1)'+'\n')
bmd.write('    hex (23 25 35 31 27 29 37 33) shape ('+str(cv)+' '+str(cd)+' 10) edgeGrading ('+str(Q22_24)+' '+str(Q22_24)+' '+str(Q22_24)+' '+str(Q22_24)+' '+str(Q22_30)+' '+str(Q22_30)+' '+str(Q22_30)+' '+str(Q22_30)+' 1 1 1 1)'+'\n')
...
#13
bmd.write('    hex (49 38 102 101 53 39 105 104) shape ('+str(cd)+' '+str(cle/4)+' 10) edgeGrading ('+str(Q49_38)+' '+str(Q101_102)+' '+str(Q101_102)+' '+str(Q49_38)+' 1 1 1 1 1 1 1 1)'+'\n')
bmd.write('    hex (101 102 30 22 104 105 32 26) shape ('+str(cd)+' '+str(cle/2)+' 10) edgeGrading ('+str(Q101_102)+' '+str(Q22_30)+' '+str(Q22_30)+' '+str(Q101_102)+' 1 1 1 1 1 1 1 1)'+'\n')

bmd.write('    hex (49 23 31 38 53 27 33 39) shape ('+str(cle/2)+' '+str(cd)+' 10) edgeGrading (1 1 1 1 '+str(Q49_38)+' '+str(Q22_30)+' '+str(Q22_30)+' '+str(Q49_38)+' 1 1 1 1)'+'\n')
...
bmd.write('arc 40 56 ('+str(c/2+mcyl*np.cos(1.570796327-0.2))+' 1.4 '+str(mcyl*np.sin(1.570796327-0.2))+')'+'\n')
# bmd.write('arc 56 41 ('+str(c/2+mcyl*np.cos(0.2))+' 0.5 '+str(mcyl*np.sin(0.2))+')'+'\n')
bmd.write('arc 56 100 ('+str(c/2+mcyl*np.cos(3*alpha64/4))+' 1.4 '+str(mcyl*np.sin(3*alpha64/4))+')'+'\n')
bmd.write('arc 100 41 ('+str(c/2+mcyl*np.cos(alpha64/4))+' 1.4 '+str(mcyl*np.sin(alpha64/4))+')'+'\n')

bmd.write('arc 41 57 ('+str(c/2+mcyl*np.cos(0.2))+' 1.4 '+str(-mcyl*np.sin(0.2))+')'+'\n')
bmd.write('arc 57 42 ('+str(c/2+mcyl*np.cos(1.570796327-0.2))+' 1.4 '+str(-mcyl*np.sin(1.570796327-0.2))+')'+'\n')
...
bmd.write('arc 44 58 ('+str(c/2+mcyl*np.cos(1.570796327-0.2))+' -0.5 '+str(mcyl*np.sin(1.570796327-0.2))+')'+'\n')
# bmd.write('arc 58 45 ('+str(c/2+mcyl*np.cos(0.2))+' -0.5 '+str(mcyl*np.sin(0.2))+')'+'\n')
bmd.write('arc 58 103 ('+str(c/2+mcyl*np.cos(3*alpha64/4))+' -0.5 '+str(mcyl*np.sin(3*alpha64/4))+')'+'\n')
bmd.write('arc 103 45 ('+str(c/2+mcyl*np.cos(alpha64/4))+' -0.5 '+str(mcyl*np.sin(alpha64/4))+')'+'\n')

bmd.write('arc 45 59 ('+str(c/2+mcyl*np.cos(0.2))+' -0.5 '+str(-mcyl*np.sin(0.2))+')'+'\n')
bmd.write('arc 59 46 ('+str(c/2+mcyl*np.cos(1.570796327-0.2))+' -0.5 '+str(-mcyl*np.sin(1.570796327-0.2))+')'+'\n')
bmd.write('arc 46 47 ('+str(c/2-mcyl*np.cos(0.7853981634))+' -0.5 '+str(-mcyl*np.sin(0.7853981634))+')'+'\n')
bmd.write('arc 51 48 ('+str(c/2-lcyl*np.cos(0.7853981634))+' 1.4 '+str(lcyl*np.sin(0.7853981634))+')'+'\n')
bmd.write('arc 48 22 ('+str(c/2+lcyl*np.cos(1.570796327-0.2))+' 1.4 '+str(lcyl*np.sin(1.570796327-0.2))+')'+'\n')
# bmd.write('arc 22 49 ('+str(c/2+lcyl*np.cos(0.2))+' 0.5 '+str(lcyl*np.sin(0.2))+')'+'\n')
bmd.write('arc 22 101 ('+str(c/2+lcyl*np.cos(3*alpha64/4))+' 1.4 '+str(lcyl*np.sin(3*alpha64/4))+')'+'\n')
bmd.write('arc 101 49 ('+str(c/2+lcyl*np.cos(alpha64/4))+' 1.4 '+str(lcyl*np.sin(alpha64/4))+')'+'\n')

bmd.write('arc 49 23 ('+str(c/2+lcyl*np.cos(0.2))+' 1.4 '+str(-lcyl*np.sin(0.2))+')'+'\n')
bmd.write('arc 23 50 ('+str(c/2+lcyl*np.cos(1.570796327-0.2))+' 1.4 '+str(-lcyl*np.sin(1.570796327-0.2))+')'+'\n')
bmd.write('arc 50 51 ('+str(c/2-lcyl*np.cos(0.7853981634))+' 1.4 '+str(-lcyl*np.sin(0.7853981634))+')'+'\n')
bmd.write('arc 55 52 ('+str(c/2-lcyl*np.cos(0.7853981634))+' -0.5 '+str(lcyl*np.sin(0.7853981634))+')'+'\n')
bmd.write('arc 52 26 ('+str(c/2+lcyl*np.cos(1.570796327-0.2))+' -0.5 '+str(lcyl*np.sin(1.570796327-0.2))+')'+'\n')
# bmd.write('arc 26 53 ('+str(c/2+lcyl*np.cos(0.2))+' -0.5 '+str(lcyl*np.sin(0.2))+')'+'\n')
bmd.write('arc 26 104 ('+str(c/2+lcyl*np.cos(3*alpha64/4))+' -0.5 '+str(lcyl*np.sin(3*alpha64/4))+')'+'\n')
bmd.write('arc 104 53 ('+str(c/2+lcyl*np.cos(alpha64/4))+' -0.5 '+str(lcyl*np.sin(alpha64/4))+')'+'\n')

bmd.write('arc 53 27 ('+str(c/2+lcyl*np.cos(0.2))+' -0.5 '+str(-lcyl*np.sin(0.2))+')'+'\n')
bmd.write('arc 27 54 ('+str(c/2+lcyl*np.cos(1.570796327-0.2))+' -0.5 '+str(-lcyl*np.sin(1.570796327-0.2))+')'+'\n')
bmd.write('arc 54 55 ('+str(c/2-lcyl*np.cos(0.7853981634))+' -0.5 '+str(-lcyl*np.sin(0.7853981634))+')'+'\n')
bmd.write('arc 16 17 ('+str(-13*c*np.cos(0.7853981634))+' 1.4 '+str(13*c*np.cos(0.7853981634))+')'+'\n')
bmd.write('arc 16 18 ('+str(-13*c*np.cos(0.7853981634))+' 1.4 '+str(-13*c*np.cos(0.7853981634))+')'+'\n')
bmd.write('arc 19 20 ('+str(-13*c*np.cos(0.7853981634))+' -0.5 '+str(13*c*np.cos(0.7853981634))+')'+'\n')
bmd.write('arc 19 21 ('+str(-13*c*np.cos(0.7853981634))+' -0.5 '+str(-13*c*np.cos(0.7853981634))+')'+'\n')
